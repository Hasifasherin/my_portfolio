const ProfileCard = () => {
  return (
    <div className="hidden lg:block fixed top-28 left-8 w-96 z-10">
      <div className="bg-purple-900 rounded-xl p-8 text-center shadow-xl min-h-[560px]">
        <img
          src="/profile.png"
          alt="Hasifa Sherin"
        ...
        <div className="flex justify-center gap-5 mt-5 text-white text-xl">
          <a href="https://www.linkedin.com/in/hasifa-sherin-cp/" target="_blank" rel="noreferrer">
            <i className="fab fa-linkedin"></i>
          </a>
          <a href="https://github.com/Hasifasherin" target="_blank" rel="noreferrer">
